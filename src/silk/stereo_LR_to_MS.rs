...
pub mod main_h {
    ...
    extern "C" {
        #[c2rust::src_loc = "85:1"]
        pub fn silk_stereo_quant_pred(pred_Q13: *mut opus_int32, ix: *mut [opus_int8; 3]);
        #[c2rust::src_loc = "75:1"]
...
pub unsafe extern "C" fn silk_stereo_LR_to_MS(
    ...
    let mut mid: *mut opus_int16 = &mut *x1.offset(-(2 as libc::c_int) as isize) as *mut opus_int16;
    ...
    while n < frame_length {
        ...
        *HP_mid.as_mut_ptr().offset(n as isize) =
            (*mid.offset((n + 1 as libc::c_int) as isize) as libc::c_int - sum) as opus_int16;
        n += 1;
    }
    ...
    while n < frame_length {
        sum = if 2 as libc::c_int == 1 as libc::c_int {
            (*side.as_mut_ptr().offset(n as isize) as libc::c_int
                + *side.as_mut_ptr().offset((n + 2 as libc::c_int) as isize) as opus_int32
                + ((*side.as_mut_ptr().offset((n + 1 as libc::c_int) as isize) as opus_uint32)
                    << 1 as libc::c_int) as opus_int32
                >> 1 as libc::c_int)
                + (*side.as_mut_ptr().offset(n as isize) as libc::c_int
                    + *side.as_mut_ptr().offset((n + 2 as libc::c_int) as isize) as opus_int32
    ...
    frac_Q16 = HP_ratio_Q14
        + LP_ratio_Q14 as opus_int16 as opus_int32 * 3 as libc::c_int as opus_int16 as opus_int32;
    ...
    min_mid_rate_bps = 2000 as libc::c_int
        + fs_kHz as opus_int16 as opus_int32 * 600 as libc::c_int as opus_int16 as opus_int32;
        ...
        *mid_side_rates_bps.offset(1 as libc::c_int as isize) =
        ...
        width_Q14 = silk_DIV32_varQ(
            ...
            ((((1 as libc::c_int as libc::c_long
                ...
                * min_mid_rate_bps as opus_int16 as opus_int64
                >> 16 as libc::c_int) as opus_int32,
    ...
    *mid_only_flag = 0 as libc::c_int as opus_int8;
            ...
            || ((frac_Q16 as libc::c_long * (*state).smth_width_Q14 as opus_int64
                ...
                < (0.05f64
                    * ((1 as libc::c_int as opus_int64) << 14 as libc::c_int) as libc::c_double
                    + 0.5f64) as opus_int32)
    {
        pred_Q13[0 as libc::c_int as usize] = (*state).smth_width_Q14 as opus_int32
            * pred_Q13[0 as libc::c_int as usize] as opus_int16 as opus_int32
            >> 14 as libc::c_int;
        pred_Q13[1 as libc::c_int as usize] = (*state).smth_width_Q14 as opus_int32
                    ...
                    + 0.5f64) as opus_int32)
    {
        ...
        > (0.95f64 * ((1 as libc::c_int as opus_int64) << 14 as libc::c_int) as libc::c_double
            + 0.5f64) as opus_int32
    {
        silk_stereo_quant_pred(pred_Q13.as_mut_ptr(), ix);
        width_Q14 = ((1 as libc::c_int as libc::c_long
    ...
    w_Q24 = (((*state).width_prev_Q14 as opus_uint32) << 10 as libc::c_int) as opus_int32;
    ...
    deltaw_Q24 = ((((width_Q14 - (*state).width_prev_Q14 as libc::c_int) as libc::c_long
        * denom_Q16 as opus_int16 as opus_int64
    ...
    while n < 8 as libc::c_int * fs_kHz {
        ...
        sum = (((*mid.offset(n as isize) as libc::c_int
            + *mid.offset((n + 2 as libc::c_int) as isize) as opus_int32
            + ((*mid.offset((n + 1 as libc::c_int) as isize) as opus_uint32) << 1 as libc::c_int)
        ...
        sum = (sum as libc::c_long
            + (((*mid.offset((n + 1 as libc::c_int) as isize) as opus_int32 as opus_uint32)
    ...
    (*state).pred_prev_Q13[0 as libc::c_int as usize] =
        pred_Q13[0 as libc::c_int as usize] as opus_int16;
    (*state).pred_prev_Q13[1 as libc::c_int as usize] =
        pred_Q13[1 as libc::c_int as usize] as opus_int16;
