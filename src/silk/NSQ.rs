...
pub mod NSQ_h {
    ...
    pub unsafe extern "C" fn silk_NSQ_noise_shape_feedback_loop_c(
        ...
        *data1.offset(0 as libc::c_int as isize) = tmp2;
        ...
        out = (out as libc::c_long
            + (tmp2 as libc::c_long
                * *coef.offset(0 as libc::c_int as isize) as opus_int64
                >> 16 as libc::c_int)) as opus_int32;
        j = 2 as libc::c_int;
        while j < order {
...
pub use self::define_h::{
    MAX_SHAPE_LPC_ORDER, HARM_SHAPE_FIR_TAPS, LTP_ORDER, NSQ_LPC_BUF_LENGTH,
    MAX_LPC_ORDER, TYPE_VOICED,
};
...
pub use self::NSQ_h::{
    silk_noise_shape_quantizer_short_prediction_c, silk_NSQ_noise_shape_feedback_loop_c,
};
...
unsafe extern "C" fn silk_noise_shape_quantizer(
    ...
    psLPC_Q14 = &mut *((*NSQ).sLPC_Q14)
        .as_mut_ptr()
        .offset((NSQ_LPC_BUF_LENGTH - 1 as libc::c_int) as isize) as *mut opus_int32;
    i = 0 as libc::c_int;
    while i < length {
        (*NSQ)
        ...
        n_AR_Q12 = (n_AR_Q12 as libc::c_long
            ...
            as opus_int32;
        n_LF_Q12 = ((*NSQ)
            .sLTP_shp_Q14[((*NSQ).sLTP_shp_buf_idx - 1 as libc::c_int) as usize]
            as libc::c_long * LF_shp_Q14 as opus_int16 as opus_int64
            >> 16 as libc::c_int) as opus_int32;
        n_LF_Q12 = (n_LF_Q12 as libc::c_long
            + ((*NSQ).sLF_AR_shp_Q14 as libc::c_long
                * (LF_shp_Q14 as opus_int64 >> 16 as libc::c_int) >> 16 as libc::c_int))
            as opus_int32;
        ...
        tmp1 = ((LPC_pred_Q10 as opus_uint32) << 2 as libc::c_int) as opus_int32
            - n_AR_Q12;
        tmp1 = tmp1 - n_LF_Q12;
        ...
        *pulses
        ...
        xq_Q14 = LPC_exc_Q14
            + ((LPC_pred_Q10 as opus_uint32) << 4 as libc::c_int) as opus_int32;
        *xq
            .offset(
                i as isize,
            ...
            ((xq_Q14 as opus_int64 * Gain_Q10 as libc::c_long >> 16 as libc::c_int)
                as opus_int32 >> 8 as libc::c_int - 1 as libc::c_int) + 1 as libc::c_int
                >> 1 as libc::c_int
        }) > silk_int16_MAX
        {
            silk_int16_MAX
        ...
        *psLPC_Q14 = xq_Q14;
        (*NSQ)
            .sDiff_shp_Q14 = xq_Q14
            - ((*x_sc_Q10.offset(i as isize) as opus_uint32) << 4 as libc::c_int)
                as opus_int32;
        sLF_AR_shp_Q14 = (*NSQ).sDiff_shp_Q14
            - ((n_AR_Q12 as opus_uint32) << 2 as libc::c_int) as opus_int32;
        (*NSQ).sLF_AR_shp_Q14 = sLF_AR_shp_Q14;
        (*NSQ)
            .sLTP_shp_Q14[(*NSQ).sLTP_shp_buf_idx
            as usize] = sLF_AR_shp_Q14
            - ((n_LF_Q12 as opus_uint32) << 2 as libc::c_int) as opus_int32;
        *sLTP_Q15
            .offset(
                (*NSQ).sLTP_buf_idx as isize,
            ) = ((LPC_exc_Q14 as opus_uint32) << 1 as libc::c_int) as opus_int32;
        (*NSQ).sLTP_shp_buf_idx += 1;
        (*NSQ).sLTP_buf_idx += 1;
        (*NSQ)
            .rand_seed = ((*NSQ).rand_seed as opus_uint32)
...
unsafe extern "C" fn silk_nsq_scale_states(
    ...
    if *Gains_Q16.offset(subfr as isize) != (*NSQ).prev_gain_Q16 {
        ...
        (*NSQ)
            .sLF_AR_shp_Q14 = (gain_adj_Q16 as opus_int64
            * (*NSQ).sLF_AR_shp_Q14 as libc::c_long >> 16 as libc::c_int) as opus_int32;
        (*NSQ)
            .sDiff_shp_Q14 = (gain_adj_Q16 as opus_int64
            * (*NSQ).sDiff_shp_Q14 as libc::c_long >> 16 as libc::c_int) as opus_int32;
        i = 0 as libc::c_int;
        while i < NSQ_LPC_BUF_LENGTH {
            (*NSQ)
                .sLPC_Q14[i
                as usize] = (gain_adj_Q16 as opus_int64
                * (*NSQ).sLPC_Q14[i as usize] as libc::c_long >> 16 as libc::c_int)
                as opus_int32;
            i += 1;
        }
        i = 0 as libc::c_int;
        while i < MAX_SHAPE_LPC_ORDER {
            (*NSQ)
                .sAR2_Q14[i
                as usize] = (gain_adj_Q16 as opus_int64
                * (*NSQ).sAR2_Q14[i as usize] as libc::c_long >> 16 as libc::c_int)
                as opus_int32;
            i += 1;
        }
