...
pub use self::resampler_rom_h::{RESAMPLER_ORDER_FIR_12, silk_resampler_frac_FIR_12};
...
unsafe extern "C" fn silk_resampler_private_IIR_FIR_INTERPOL(
    ...
    while index_Q16 < max_index_Q16 {
        table_index = ((index_Q16 & 0xffff as libc::c_int) as libc::c_long
            * 12 as libc::c_int as opus_int16 as opus_int64 >> 16 as libc::c_int)
            as opus_int32;
        ...
        res_Q15 = res_Q15
            + *buf_ptr.offset(1 as libc::c_int as isize) as opus_int32
                * silk_resampler_frac_FIR_12[table_index
                    as usize][1 as libc::c_int as usize] as opus_int32;
        res_Q15 = res_Q15
            + *buf_ptr.offset(2 as libc::c_int as isize) as opus_int32
                * silk_resampler_frac_FIR_12[table_index
                    as usize][2 as libc::c_int as usize] as opus_int32;
        res_Q15 = res_Q15
            + *buf_ptr.offset(3 as libc::c_int as isize) as opus_int32
                * silk_resampler_frac_FIR_12[table_index
                    as usize][3 as libc::c_int as usize] as opus_int32;
        res_Q15 = res_Q15
            + *buf_ptr.offset(4 as libc::c_int as isize) as opus_int32
                * silk_resampler_frac_FIR_12[(11 as libc::c_int - table_index)
                    as usize][3 as libc::c_int as usize] as opus_int32;
        res_Q15 = res_Q15
        ...
        res_Q15 = res_Q15
            + *buf_ptr.offset(7 as libc::c_int as isize) as opus_int32
                * silk_resampler_frac_FIR_12[(11 as libc::c_int - table_index)
                    as usize][0 as libc::c_int as usize] as opus_int32;
        let fresh0 = out;
        out = out.offset(1);
...
pub unsafe extern "C" fn silk_resampler_private_IIR_FIR(
    ...
    loop {
        ...
        max_index_Q16 = ((nSamplesIn as opus_uint32)
            << 16 as libc::c_int + 1 as libc::c_int) as opus_int32;
        ...
        memcpy(
            buf.as_mut_ptr() as *mut libc::c_void,
            &mut *buf.as_mut_ptr().offset((nSamplesIn << 1 as libc::c_int) as isize)
