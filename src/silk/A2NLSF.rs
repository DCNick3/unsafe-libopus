...
pub use self::SigProc_FIX_h::{silk_min_32, silk_bwexpander_32};
...
unsafe extern "C" fn silk_A2NLSF_trans_poly(p: *mut opus_int32, dd: libc::c_int) {
    ...
    while k <= dd {
        ...
        *fresh1
            -= ((*p.offset(k as isize) as opus_uint32) << 1 as libc::c_int)
                as opus_int32;
        k += 1;
    }
}
...
pub unsafe extern "C" fn silk_A2NLSF(
    ...
    loop {
        ...
        if ylo <= 0 as libc::c_int && yhi >= thr
            || ylo >= 0 as libc::c_int && yhi <= -thr
        {
            ...
            if (if ylo > 0 as libc::c_int { ylo } else { -ylo }) < 65536 as libc::c_int {
                den = ylo - yhi;
                nom = ((ylo as opus_uint32) << 8 as libc::c_int - 3 as libc::c_int)
                    as opus_int32 + (den >> 1 as libc::c_int);
            ...
            if k > LSF_COS_TAB_SZ_FIX {
                ...
                if i > MAX_ITERATIONS_A2NLSF_FIX {
                    *NLSF
                        ...
                        / (d + 1 as libc::c_int)) as opus_int16;
                    k = 1 as libc::c_int;
                    while k < d {
                        *NLSF
                            .offset(
                                k as isize,
                            ) = (*NLSF.offset((k - 1 as libc::c_int) as isize)
                            as libc::c_int
                ...
                silk_bwexpander_32(
                    ...
                    d,
                    65536 as libc::c_int
                        - ((1 as libc::c_int as opus_uint32) << i) as opus_int32,
                );
                silk_A2NLSF_init(a_Q16, P.as_mut_ptr(), Q.as_mut_ptr(), dd);
                p = P.as_mut_ptr();
                xlo = silk_LSFCosTab_FIX_Q12[0 as libc::c_int as usize] as opus_int32;
