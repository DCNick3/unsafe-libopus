...
pub mod resampler_rom_h {
    ...
    pub static mut silk_resampler_down2_0: opus_int16 = 9872 as libc::c_int as opus_int16;
    #[c2rust::src_loc = "46:25"]
    pub static mut silk_resampler_down2_1: opus_int16 =
...
pub unsafe extern "C" fn silk_resampler_down2(
    ...
    while k < len2 {
        ...
        X = (Y as libc::c_long
            + (Y as libc::c_long * silk_resampler_down2_1 as opus_int64 >> 16 as libc::c_int))
            as opus_int32;
        ...
        *S.offset(0 as libc::c_int as isize) = in32 + X;
        ...
        X = (Y as libc::c_long * silk_resampler_down2_0 as opus_int64 >> 16 as libc::c_int)
            as opus_int32;
