...
pub unsafe extern "C" fn silk_NLSF_unpack(
    ...
    while i < (*psNLSF_CB).order as libc::c_int {
        ...
        *ec_ix.offset(i as isize) = ((entry as libc::c_int >> 1 as libc::c_int & 7 as libc::c_int)
            ...
            * (2 as libc::c_int * 4 as libc::c_int + 1 as libc::c_int) as opus_int16 as opus_int32)
            as opus_int16;
        ...
        *ec_ix.offset((i + 1 as libc::c_int) as isize) = ((entry as libc::c_int >> 5 as libc::c_int
            & 7 as libc::c_int)
            as opus_int16 as opus_int32
            * (2 as libc::c_int * 4 as libc::c_int + 1 as libc::c_int) as opus_int16 as opus_int32)
            as opus_int16;
