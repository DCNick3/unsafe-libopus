...
pub unsafe extern "C" fn silk_VQ_WMat_EC_c(
    ...
    mut res_nrg_Q15: *mut opus_int32,
    mut rate_dist_Q8: *mut opus_int32,
    mut gain_Q7: *mut libc::c_int,
    mut XX_Q17: *const opus_int32,
    mut xX_Q17: *const opus_int32,
    mut cb_Q7: *const opus_int8,
    mut cb_gain_Q7: *const opus_uint8,
    mut cl_Q5: *const opus_uint8,
    ...
    neg_xX_Q24[0 as libc::c_int
        as usize] = -(((*xX_Q17.offset(0 as libc::c_int as isize) as opus_uint32)
        << 7 as libc::c_int) as opus_int32);
    neg_xX_Q24[1 as libc::c_int
        as usize] = -(((*xX_Q17.offset(1 as libc::c_int as isize) as opus_uint32)
        << 7 as libc::c_int) as opus_int32);
    neg_xX_Q24[2 as libc::c_int
        as usize] = -(((*xX_Q17.offset(2 as libc::c_int as isize) as opus_uint32)
        << 7 as libc::c_int) as opus_int32);
    neg_xX_Q24[3 as libc::c_int
        as usize] = -(((*xX_Q17.offset(3 as libc::c_int as isize) as opus_uint32)
        << 7 as libc::c_int) as opus_int32);
    neg_xX_Q24[4 as libc::c_int
        as usize] = -(((*xX_Q17.offset(4 as libc::c_int as isize) as opus_uint32)
        << 7 as libc::c_int) as opus_int32);
    ...
    *ind = 0 as libc::c_int as opus_int8;
    ...
    while k < L {
        ...
        penalty = (((if gain_tmp_Q7 - max_gain_Q7 > 0 as libc::c_int {
            ...
            0 as libc::c_int
        }) as opus_uint32) << 11 as libc::c_int) as opus_int32;
        ...
        sum1_Q15 = (sum1_Q15 as libc::c_long
            + (sum2_Q24 as libc::c_long
                * *cb_row_Q7.offset(0 as libc::c_int as isize) as opus_int16
        ...
        sum1_Q15 = (sum1_Q15 as libc::c_long
            + (sum2_Q24 as libc::c_long
                * *cb_row_Q7.offset(1 as libc::c_int as isize) as opus_int16
                    as opus_int64 >> 16 as libc::c_int)) as opus_int32;
        ...
        sum1_Q15 = (sum1_Q15 as libc::c_long
            + (sum2_Q24 as libc::c_long
                * *cb_row_Q7.offset(2 as libc::c_int as isize) as opus_int16
                    as opus_int64 >> 16 as libc::c_int)) as opus_int32;
        ...
        sum1_Q15 = (sum1_Q15 as libc::c_long
            + (sum2_Q24 as libc::c_long
                * *cb_row_Q7.offset(3 as libc::c_int as isize) as opus_int16
                    as opus_int64 >> 16 as libc::c_int)) as opus_int32;
        sum2_Q24 = ((neg_xX_Q24[4 as libc::c_int as usize] as opus_uint32)
        ...
        sum1_Q15 = (sum1_Q15 as libc::c_long
            + (sum2_Q24 as libc::c_long
                * *cb_row_Q7.offset(4 as libc::c_int as isize) as opus_int16
                    as opus_int64 >> 16 as libc::c_int)) as opus_int32;
        if sum1_Q15 >= 0 as libc::c_int {
            bits_res_Q8 = subfr_len as opus_int16 as opus_int32
                * (silk_lin2log(sum1_Q15 + penalty)
                    - ((15 as libc::c_int) << 7 as libc::c_int)) as opus_int16
                    as opus_int32;
