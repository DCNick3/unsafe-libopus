...
pub unsafe fn silk_ROR32(a32: i32, rot: libc::c_int) -> i32 {
...
pub unsafe fn silk_min_int(a: libc::c_int, b: libc::c_int) -> libc::c_int {
    return if a < b { a } else { b };
}
#[inline]
#[c2rust::src_loc = "564:1"]
pub unsafe fn silk_max_int(a: libc::c_int, b: libc::c_int) -> libc::c_int {
    return if a > b { a } else { b };
}
