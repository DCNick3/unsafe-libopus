    ...
    while k < len {
        ...
        out32_Q14 = (((*S.offset(0 as libc::c_int as isize) as libc::c_long
            + (*B_Q28.offset(0 as libc::c_int as isize) as libc::c_long
                * inval as opus_int16 as opus_int64 >> 16 as libc::c_int)) as opus_int32
        ...
        *out
            ...
            - 1 as libc::c_int >> 14 as libc::c_int > silk_int16_MAX
        {
            silk_int16_MAX
        } else if (out32_Q14 + ((1 as libc::c_int) << 14 as libc::c_int)
            - 1 as libc::c_int >> 14 as libc::c_int) < silk_int16_MIN
        {
            silk_int16_MIN
        } else {
...
pub unsafe extern "C" fn silk_biquad_alt_stride2_c(
    ...
    k = 0 as libc::c_int;
    while k < len {
        out32_Q14[0 as libc::c_int
            as usize] = (((*S.offset(0 as libc::c_int as isize) as libc::c_long
            + (*B_Q28.offset(0 as libc::c_int as isize) as libc::c_long
                * *in_0.offset((2 as libc::c_int * k + 0 as libc::c_int) as isize)
                    as opus_int64 >> 16 as libc::c_int)) as opus_int32 as opus_uint32)
            << 2 as libc::c_int) as opus_int32;
        out32_Q14[1 as libc::c_int
            as usize] = (((*S.offset(2 as libc::c_int as isize) as libc::c_long
            + (*B_Q28.offset(0 as libc::c_int as isize) as libc::c_long
        ...
        *S
            ...
            + (if 14 as libc::c_int == 1 as libc::c_int {
                ((out32_Q14[0 as libc::c_int as usize] as libc::c_long
                    * A0_L_Q28 as opus_int16 as opus_int64 >> 16 as libc::c_int)
                ...
                ((out32_Q14[0 as libc::c_int as usize] as libc::c_long
                    * A0_L_Q28 as opus_int16 as opus_int64 >> 16 as libc::c_int)
                    as opus_int32 >> 14 as libc::c_int - 1 as libc::c_int)
        ...
        *S
            ...
            + (out32_Q14[0 as libc::c_int as usize] as libc::c_long
                * A0_U_Q28 as opus_int16 as opus_int64 >> 16 as libc::c_int))
            as opus_int32;
        *S
            .offset(
                2 as libc::c_int as isize,
        ...
        *S
            ...
            ((out32_Q14[0 as libc::c_int as usize] as libc::c_long
                * A1_L_Q28 as opus_int16 as opus_int64 >> 16 as libc::c_int)
                as opus_int32 >> 1 as libc::c_int)
                + ((out32_Q14[0 as libc::c_int as usize] as libc::c_long
                    * A1_L_Q28 as opus_int16 as opus_int64 >> 16 as libc::c_int)
                    as opus_int32 & 1 as libc::c_int)
            ...
            ((out32_Q14[0 as libc::c_int as usize] as libc::c_long
                * A1_L_Q28 as opus_int16 as opus_int64 >> 16 as libc::c_int)
                as opus_int32 >> 14 as libc::c_int - 1 as libc::c_int) + 1 as libc::c_int
                >> 1 as libc::c_int
        };
        *S
            .offset(
        ...
        *S
            ...
            + (out32_Q14[0 as libc::c_int as usize] as libc::c_long
                * A1_U_Q28 as opus_int16 as opus_int64 >> 16 as libc::c_int))
            as opus_int32;
        *S
            .offset(
                3 as libc::c_int as isize,
            ) = (*S.offset(3 as libc::c_int as isize) as libc::c_long
            + (out32_Q14[1 as libc::c_int as usize] as libc::c_long
                * A1_U_Q28 as opus_int16 as opus_int64 >> 16 as libc::c_int))
            as opus_int32;
        *S
        ...
        *out
            .offset(
                (2 as libc::c_int * k + 0 as libc::c_int) as isize,
            ) = (if out32_Q14[0 as libc::c_int as usize]
            + ((1 as libc::c_int) << 14 as libc::c_int) - 1 as libc::c_int
            >> 14 as libc::c_int > silk_int16_MAX
        {
            silk_int16_MAX
        } else if (out32_Q14[0 as libc::c_int as usize]
            + ((1 as libc::c_int) << 14 as libc::c_int) - 1 as libc::c_int
            >> 14 as libc::c_int) < silk_int16_MIN
        {
            silk_int16_MIN
        } else {
        ...
        *out
            ...
            ) = (if out32_Q14[1 as libc::c_int as usize]
            + ((1 as libc::c_int) << 14 as libc::c_int) - 1 as libc::c_int
            >> 14 as libc::c_int > silk_int16_MAX
        {
            silk_int16_MAX
