...
pub unsafe extern "C" fn silk_decode_core(
    ...
    while i < (*psDec).frame_length {
        ...
        (*psDec).exc_Q14[i as usize] = ((*pulses.offset(i as isize) as opus_int32 as opus_uint32)
    ...
    while k < (*psDec).nb_subfr {
        ...
        B_Q14 = &mut *((*psDecCtrl).LTPCoef_Q14)
            .as_mut_ptr()
            .offset((k * 5 as libc::c_int) as isize) as *mut opus_int16;
        ...
        if (*psDecCtrl).Gains_Q16[k as usize] != (*psDec).prev_gain_Q16 {
            ...
            while i < 16 as libc::c_int {
                *sLPC_Q14.as_mut_ptr().offset(i as isize) = (gain_adj_Q16 as opus_int64
            ...
            && k < 4 as libc::c_int / 2 as libc::c_int
        {
            ...
            *B_Q14.offset((5 as libc::c_int / 2 as libc::c_int) as isize) =
                (0.25f64
        ...
        if signalType == 2 as libc::c_int {
            ...
            while i < (*psDec).subfr_length {
                ...
                *sLTP_Q15.as_mut_ptr().offset(sLTP_buf_idx as isize) =
                    ((*pres_Q14.offset(i as isize) as opus_uint32) << 1 as libc::c_int)
                        as opus_int32;
                sLTP_buf_idx += 1;
                i += 1;
            }
        ...
        while i < (*psDec).subfr_length {
            ...
            LPC_pred_Q10 = (LPC_pred_Q10 as libc::c_long
                + (*sLPC_Q14
                    ...
                    as libc::c_long
                    * A_Q12_tmp[0 as libc::c_int as usize] as opus_int64
                    >> 16 as libc::c_int)) as opus_int32;
            LPC_pred_Q10 = (LPC_pred_Q10 as libc::c_long
                + (*sLPC_Q14
                    .as_mut_ptr()
                    ...
                    as libc::c_long
                    * A_Q12_tmp[1 as libc::c_int as usize] as opus_int64
                    >> 16 as libc::c_int)) as opus_int32;
            LPC_pred_Q10 = (LPC_pred_Q10 as libc::c_long
                + (*sLPC_Q14
                    .as_mut_ptr()
                    ...
                    as libc::c_long
                    * A_Q12_tmp[2 as libc::c_int as usize] as opus_int64
                    >> 16 as libc::c_int)) as opus_int32;
            LPC_pred_Q10 = (LPC_pred_Q10 as libc::c_long
                + (*sLPC_Q14
                    .as_mut_ptr()
                    ...
                    as libc::c_long
                    * A_Q12_tmp[3 as libc::c_int as usize] as opus_int64
                    >> 16 as libc::c_int)) as opus_int32;
            LPC_pred_Q10 = (LPC_pred_Q10 as libc::c_long
                + (*sLPC_Q14
                    .as_mut_ptr()
                    ...
                    as libc::c_long
                    * A_Q12_tmp[4 as libc::c_int as usize] as opus_int64
                    >> 16 as libc::c_int)) as opus_int32;
            LPC_pred_Q10 = (LPC_pred_Q10 as libc::c_long
                + (*sLPC_Q14
                    .as_mut_ptr()
                    ...
                    as libc::c_long
                    * A_Q12_tmp[5 as libc::c_int as usize] as opus_int64
                    >> 16 as libc::c_int)) as opus_int32;
            LPC_pred_Q10 = (LPC_pred_Q10 as libc::c_long
                + (*sLPC_Q14
                    .as_mut_ptr()
                    ...
                    as libc::c_long
                    * A_Q12_tmp[6 as libc::c_int as usize] as opus_int64
                    >> 16 as libc::c_int)) as opus_int32;
            LPC_pred_Q10 = (LPC_pred_Q10 as libc::c_long
                + (*sLPC_Q14
                    .as_mut_ptr()
                    ...
                    as libc::c_long
                    * A_Q12_tmp[7 as libc::c_int as usize] as opus_int64
                    >> 16 as libc::c_int)) as opus_int32;
            LPC_pred_Q10 = (LPC_pred_Q10 as libc::c_long
                + (*sLPC_Q14
                    .as_mut_ptr()
                    ...
                    as libc::c_long
                    * A_Q12_tmp[8 as libc::c_int as usize] as opus_int64
                    >> 16 as libc::c_int)) as opus_int32;
            LPC_pred_Q10 = (LPC_pred_Q10 as libc::c_long
                + (*sLPC_Q14
                    .as_mut_ptr()
                    ...
                    as libc::c_long
                    * A_Q12_tmp[9 as libc::c_int as usize] as opus_int64
                    >> 16 as libc::c_int)) as opus_int32;
            ...
            *sLPC_Q14
                .as_mut_ptr()
                .offset((16 as libc::c_int + i) as isize) = if (*pres_Q14.offset(i as isize)
                as opus_uint32)
                .wrapping_add(
        ...
        memcpy(
            sLPC_Q14.as_mut_ptr() as *mut libc::c_void,
            &mut *sLPC_Q14.as_mut_ptr().offset((*psDec).subfr_length as isize) as *mut opus_int32
