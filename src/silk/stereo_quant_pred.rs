...
pub unsafe fn silk_stereo_quant_pred(pred_Q13: *mut i32, ix: *mut [i8; 3]) {
    ...
    let mut quant_pred_Q13: i32 = 0 as i32;
    n = 0 as i32;
    while n < 2 as i32 {
        err_min_Q13 = silk_int32_MAX;
        i = 0 as i32;
        's_18: while i < STEREO_QUANT_TAB_SIZE - 1 as i32 {
            low_Q13 = silk_stereo_pred_quant_Q13[i as usize] as i32;
            step_Q13 = ((silk_stereo_pred_quant_Q13[(i + 1 as i32) as usize] as i32 - low_Q13)
                as i64
            ...
            while j < STEREO_QUANT_SUB_STEPS {
                lvl_Q13 =
                    low_Q13 + step_Q13 as i16 as i32 * (2 as i32 * j + 1 as i32) as i16 as i32;
