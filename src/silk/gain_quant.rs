...
pub use self::SigProc_FIX_h::{
    silk_min_int, silk_min_32, silk_max_int, silk_lin2log, silk_log2lin,
};
pub use self::define_h::{
    MIN_QGAIN_DB, MIN_DELTA_GAIN_QUANT, N_LEVELS_QGAIN, MAX_DELTA_GAIN_QUANT,
};
#[c2rust::src_loc = "34:9"]
pub const OFFSET: libc::c_int = MIN_QGAIN_DB * 128 as libc::c_int / 6 as libc::c_int
    ...
    while k < nb_subfr {
        *ind
            ...
            * (silk_lin2log(*gain_Q16.offset(k as isize))
                ...
                as opus_int64 >> 16 as libc::c_int) as opus_int32 as opus_int8;
        ...
        *ind
        ...
        if k == 0 as libc::c_int && conditional == 0 as libc::c_int {
            *ind
                .offset(
                    k as isize,
                ) = (if *prev_ind as libc::c_int + -(4 as libc::c_int)
                > 64 as libc::c_int - 1 as libc::c_int
            {
            ...
            *ind
                .offset(
                    k as isize,
                ) = (*ind.offset(k as isize) as libc::c_int - *prev_ind as libc::c_int)
                as opus_int8;
            double_step_size_threshold = 2 as libc::c_int * MAX_DELTA_GAIN_QUANT
                - N_LEVELS_QGAIN + *prev_ind as libc::c_int;
            if *ind.offset(k as isize) as libc::c_int > double_step_size_threshold {
                *ind
                    ...
                    + (*ind.offset(k as isize) as libc::c_int
                        - double_step_size_threshold + 1 as libc::c_int
                        >> 1 as libc::c_int)) as opus_int8;
            }
            *ind
                .offset(
                    k as isize,
                ) = (if -(4 as libc::c_int) > 36 as libc::c_int {
            ...
            if *ind.offset(k as isize) as libc::c_int > double_step_size_threshold {
                *prev_ind = (*prev_ind as libc::c_int
                    + (((*ind.offset(k as isize) as opus_uint32) << 1 as libc::c_int)
                        as opus_int32 - double_step_size_threshold)) as opus_int8;
                ...
                *prev_ind = (*prev_ind as libc::c_int
                    + *ind.offset(k as isize) as libc::c_int) as opus_int8;
            }
            ...
            silk_min_32(
                ((65536 as libc::c_int
                    * ((88 as libc::c_int - 2 as libc::c_int) * 128 as libc::c_int
                    ...
                    as libc::c_long * *prev_ind as opus_int16 as opus_int64
                    >> 16 as libc::c_int) as opus_int32 + OFFSET,
                3967 as libc::c_int,
            ),
        );
        k += 1;
