...
pub unsafe fn check(
    ...
    while bin < nfft {
        ...
        let mut ansi: libc::c_double = 0 as libc::c_int as libc::c_double;
        let mut difr: libc::c_double = 0.;
        let mut difi: libc::c_double = 0.;
        k = 0 as libc::c_int;
        while k < nfft {
            let mut phase: libc::c_double = -(2 as libc::c_int) as libc::c_double
                * 3.14159265358979323846f64
                * bin as libc::c_double
                * k as libc::c_double
                / nfft as libc::c_double;
            let mut re: libc::c_double = cos(phase);
            let mut im: libc::c_double = sin(phase);
            if isinverse != 0 {
                im = -im;
            }
            if isinverse == 0 {
                re /= nfft as libc::c_double;
                im /= nfft as libc::c_double;
            }
            ansr += (*in_0.offset(k as isize)).r as libc::c_double * re
                - (*in_0.offset(k as isize)).i as libc::c_double * im;
            ansi += (*in_0.offset(k as isize)).r as libc::c_double * im
                + (*in_0.offset(k as isize)).i as libc::c_double * re;
            k += 1;
        }
        difr = ansr - (*out.offset(bin as isize)).r as libc::c_double;
        difi = ansi - (*out.offset(bin as isize)).i as libc::c_double;
...
pub unsafe fn test1d(
    ...
    let mut buflen: size_t = (::core::mem::size_of::<kiss_fft_cpx>() as libc::c_ulong)
    ...
    if nfft == 480 as libc::c_int {
        id = 0 as libc::c_int;
    } else if nfft == 240 as libc::c_int {
        id = 1 as libc::c_int;
    } else if nfft == 120 as libc::c_int {
        id = 2 as libc::c_int;
    } else if nfft == 60 as libc::c_int {
        id = 3 as libc::c_int;
    } else {
        return;
    }
    ...
    while k < nfft {
        (*in_0.offset(k as isize)).r =
            (rand() % 32767 as libc::c_int - 16384 as libc::c_int) as libc::c_float;
    ...
    k = 0 as libc::c_int;
    while k < nfft {
        (*in_0.offset(k as isize)).r *= 32768 as libc::c_int as libc::c_float;
        (*in_0.offset(k as isize)).i *= 32768 as libc::c_int as libc::c_float;
        k += 1;
    }
    if isinverse != 0 {
        k = 0 as libc::c_int;
        while k < nfft {
            (*in_0.offset(k as isize)).r /= nfft as libc::c_float;
            (*in_0.offset(k as isize)).i /= nfft as libc::c_float;
            k += 1;
        }
    }
    if isinverse != 0 {
...
unsafe fn main_0(mut argc: libc::c_int, mut argv: *mut *mut libc::c_char) -> libc::c_int {
    ...
    if argc > 1 as libc::c_int {
        ...
        test1d(128 as libc::c_int, 0 as libc::c_int, arch);
        test1d(128 as libc::c_int, 1 as libc::c_int, arch);
        ...
        test1d(50 as libc::c_int, 0 as libc::c_int, arch);
        test1d(50 as libc::c_int, 1 as libc::c_int, arch);
